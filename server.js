...
app.post('/usuarios', (req, res) =>{
    ...
    execSQLQuery(`INSERT INTO Usuarios(Nome, Email, Senha, Tipousuario) VALUES('${nome}','${email}','${senha}','${tipousuario}')`, res);
...
app.patch('/usuarios/:id', (req, res) =>{
    ...
    const email = req.body.email.substring(0,200);
    const senha = req.body.senha.substring(0,10);
    execSQLQuery(`UPDATE Usuarios SET Nome='${nome}', Email='${email}', Senha='${senha}' WHERE ID=${id}`, res);
});
...
app.post('/techshots', (req, res) =>{
    ...
    execSQLQuery(`INSERT INTO Techshots(Titulo, Descricao) VALUES('${titulo}','${descricao}')`, res);
});
...
app.patch('/techshots/:id', (req, res) =>{
    ...
    const titulo = req.body.titulo.substring(0,150);
    const descricao = req.body.descricao.substring(0,300);
    execSQLQuery(`UPDATE Techshots SET Titulo='${titulo}', Descricao='${descricao}' WHERE ID=${id}`, res);
});
